...
const NewProduct = lazy(() => import("./pages/shop-product/NewProduct"));
const PendingApproval = lazy(() => import("./pages/shop-product/PendingApproval"));
// blog pages
        ...
        <ScrollToTop>
          ...
          >
            <Routes>
              ...
              />
              <Route
                path={process.env.PUBLIC_URL + "/pending-approval"}
